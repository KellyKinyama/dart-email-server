...
/// Generate a random AES key of [bytes] length (16 = AES-128, 32 = AES-256).
Uint8List aesGenerateKey({int bytes = 16}) {
  if (bytes != 16 && bytes != 24 && bytes != 32) {
    throw ArgumentError('AES key length must be 16, 24, or 32 bytes');
  }
